...
impl Line {
  pub fn new() -> Self {
    Self { spaces: 0, key: String::from(""), need_colon: false, value: String::from(""), need_comma: false, need_start_dict_blancket: false, need_end_dict_blancket: false, need_start_list_blancket: false, need_end_list_blancket: false }
  }
...
impl fmt::Display for Line {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    write!(f, "{}{}{}{}{}{}{}{}{}\n",
      ...
      self.value,
      if self.need_start_dict_blancket {"{"} else {""},
      if self.need_end_dict_blancket {"}"} else {""},
      if self.need_start_list_blancket {"["} else {""},
