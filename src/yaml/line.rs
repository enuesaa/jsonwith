...
impl Line {
  pub fn new() -> Self {
    Self { spaces: 0, need_hyphen: false, key: String::from(""), need_colon: false, value: String::from(""), need_empty_dict_blancket: false, need_empty_list_blancket: false }
  }
  ...
  pub fn is_hyphen_only(&mut self) -> bool {
    self.need_hyphen == true && self.key == String::from("") && self.need_colon == false && self.value == String::from("") && self.need_empty_dict_blancket == false && self.need_empty_list_blancket == false
  }
}
...
impl fmt::Display for Line {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    write!(f, "{}{}{}{}{}{}{}\n",
      ...
      self.value,
      if self.need_empty_dict_blancket {"{}"} else {""},
      if self.need_empty_list_blancket {"[]"} else {""},
    )
  }
}